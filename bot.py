...
🔸 הכתבות שלי: לחץ על הכפתור כדי לראות את כל הכתבות השמורות
🔸 רשימת כתבות: רשימה עם כפתורי צפייה ומחיקה לכל כתבה
🔸 חיפוש: לחץ על הכפתור ואז כתוב מילות חיפוש ישירות
🔸 גיבוי: קבל קובץ עם כל הכתבות שלך
🔸 סטטיסטיקות: ראה סיכום הכתבות שלך לפי קטגוריות

📂 קטגוריות אוטומטיות:
• טכנולוגיה • בריאות • כלכלה • פוליטיקה • השראה • כללי

⚡ פקודות מתקדמות (אופציונלי):
